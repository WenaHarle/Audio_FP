...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description="Real-time microphone matcher (tuned profile) with serial output.")
    parser.add_argument("--database", default=str(REPO_ROOT / "DataBase" / "Oleg6.json"), help="Path to fingerprint JSON database.")
    parser.add_argument("--threshold", type=float, default=0.009, help="Detection threshold for match ratio.")
